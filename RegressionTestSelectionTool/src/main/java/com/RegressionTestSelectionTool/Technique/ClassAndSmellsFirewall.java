...
public class ClassAndSmellsFirewall extends SelectionTechnique {
	...
	public ClassAndSmellsFirewall(DependenciesField oldestVersionClassDependencies,
		...
		super(SelectionTechniqueEnum.CLASS_FIREWALL_WITH_SMELLS, 
