...
public class ChangeAndSmellBased extends SelectionTechnique {
	...
	public ChangeAndSmellBased(DependenciesField oldestVersionClassDependencies,
		...
		super(SelectionTechniqueEnum.CHANGE_AND_SMELL_BASED, 
