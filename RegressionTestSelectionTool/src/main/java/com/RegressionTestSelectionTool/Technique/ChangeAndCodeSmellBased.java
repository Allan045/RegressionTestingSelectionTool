...
public class ChangeAndCodeSmellBased extends SelectionTechnique {
	...
	public ChangeAndCodeSmellBased(DependenciesField oldestVersionClassDependencies,
		...
		super(SelectionTechniqueEnum.CHANGE_AND_CODE_SMELL_BASED, 
		...
		System.out.println("Change and Code Smell Based TestSet: "+this.selectedTestClasses.toString());
		System.out.println("");
