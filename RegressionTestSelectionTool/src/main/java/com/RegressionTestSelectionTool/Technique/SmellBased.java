...
public class SmellBased extends SelectionTechnique {

	protected Set<String> selectedViolations;
	protected Set<String> classesWithViolations;	
	
	public SmellBased(DependenciesField oldestVersionClassDependencies,
		...
		super(SelectionTechniqueEnum.SMELL_BASED, 
