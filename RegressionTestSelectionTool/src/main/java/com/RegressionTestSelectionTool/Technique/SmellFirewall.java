...
public class SmellFirewall extends SelectionTechnique {

	protected Set<String> selectedViolations;
	protected Set<String> classesWithViolations;
	
	public SmellFirewall(DependenciesField oldestVersionClassDependencies,
		...
		super(SelectionTechniqueEnum.SMELL_FIREWALL, 
